...
public class LuckyNumberPage extends BasePage {
	...
	/*
	 * public void isDrawgameSelected(){ if(
	 * findElement(LuckeyNumberPageLocator.drawgamelocator,
	 * 5).getCssValue("border-bottom") != null){
	 * LOGGER.info("Draw Game Is Selected"); } else{
	 * LOGGER.error("Unable To Select DG"); Assert.fail(); }
	 * 
	 * }
	 */
	 ...
	 * 
	 * if(findElement(LuckeyNumberPageLocator.luckynumberlocator,
	 * 5).getAttribute("gamename").equalsIgnoreCase("KenoTwo")) {
	 * //System.out.println(true); LOGGER.info("Lucky Number Game Is Selected");
	 * } else { //System.out.println(false); Assert.fail(); }
	 * 
	 * 
	 * if( findElement(LuckeyNumberPageLocator.luckynumberlocator,
	 * 10).getAttribute("class").equalsIgnoreCase("sideMenuList select-game")){
	 * LOGGER.info("Luckey Number Is Selected"); } else{
	 * LOGGER.error("Unable To Select DG"); Assert.fail(); } }
	 */
	public void isPerm1Selected() {
		if (findElement(LuckeyNumberPageLocator.selectedBetLocator, 5).getAttribute("betname")
				.equalsIgnoreCase("Perm1")) {
	...
	public void isPerm3Selected() {
		...
		if (findElement(LuckeyNumberPageLocator.selectedBetLocator, 6).getAttribute("betname")
				.equalsIgnoreCase("Perm3")) {
	...
	public List<Map<String, String>> returnDatabaseValue() throws SQLException {
		...
		String value = ReusableStaticMethods
				.removeZeroFromticket(findElement(LuckeyNumberPageLocator.ticketnumber, 5).getText());
